/*!
 * quicktab v0.0.2 (https://github.com/ajiho/quicktab)
...
(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  class Quicktab {
    constructor(id, _options2) {
      ...
      if (id instanceof Element) {
        ...
        _classPrivateFieldSet(this, _element, id);
        //直接取id属性

        id = _classPrivateFieldGet(this, _element).getAttribute('id');
        if (!id) {
   ...
   */
  Utils.ready(() => {
    document.querySelectorAll(Constants.SELECTOR_DATA_TOGGLE).forEach(element => {

...
(function (global, factory) {
  ...
  var Utils = {
    ...
    canAccessIFrame(iframe) {
      var _ref;
      return ((_ref = iframe.contentDocument || iframe.contentWindow.document) == null || (_ref = _ref.body) == null ? void 0 : _ref.innerHTML) !== undefined;
    },
    sprintf(_str, ...args) {
      let flag = true;
      let i = 0;
  ...
  function jQueryFactory(window, noGlobal) {
    ...
    var version = '4.0.0-pre+c98597ea +event,+traversing',
      rhtmlSuffix = /HTML$/i,
    ...
    var rootjQuery,
      ...
      init = jQuery.fn.init = function (selector, context) {
        ...
        if (selector.nodeType) {
          ...
          return rootjQuery.ready !== undefined ? rootjQuery.ready(selector) :
  ...
  class Quicktab {
    constructor(options) {
      //参数合并
      this.options = Object.freeze(jQuery.extend(true, {}, Constants.DEFAULTS, options));
    ...
    _init() {
      ...
      if (this.options.cache.enable === true) {
        this.$GLOBALS.storage = new Storage(this.options.cache.type, this.options.selector);
      }
    ...
    _initMainStructure() {
      ...
      if (this.options.tabBarConfig.enable === true) {
        ...
        if (this.options.tabBarConfig.prev.enable === true) {
          html.push(Utils.sprintf(Constants.CONSTANTS.html.tabBarPrevItem, this.options.tabBarConfig.prev.icon));
        }

        //刷新
        if (this.options.tabBarConfig.refresh.enable === true) {
          html.push(Utils.sprintf(Constants.CONSTANTS.html.tabBarRefreshItem, this.options.tabBarConfig.refresh.icon));
        }
        ...
        if (this.options.tabBarConfig.next.enable === true) {
          html.push(Utils.sprintf(Constants.CONSTANTS.html.tabBarNextItem, this.options.tabBarConfig.next.icon));
        }
        //下拉菜单
        if (this.options.tabBarConfig.dropdown.enable === true) {
          html.push(Utils.sprintf(Constants.CONSTANTS.html.tabBarDropdownItem, this.options.tabBarConfig.dropdown.icon));
        }
        //全屏
        if (this.options.tabBarConfig.fullscreen.enable === true) {
          html.push(Utils.sprintf(Constants.CONSTANTS.html.tabBarFullscreenItem, this.options.tabBarConfig.fullscreen.icon));
        }
    ...
    _validateContainer() {
      ...
      if (el.classList.contains(Constants.CONSTANTS.classes.container)) {
        throw new Error(`The provided selector '${this.options.selector}' has been initialized`);
      }
      this.$GLOBALS.el = el;
    }
  }
